...
```diff
- We just changed the code to pytorch 0.4.0. So expect some issues.
- If you still want to run the old version, you can check out tag v0.2
- (which works with pytorch 0.3.0 and python 2.7 or 3).
- Going forward all development will be based on python 3 as well.
```
