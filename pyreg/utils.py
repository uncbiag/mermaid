...
def evaluate_model(ISource_in,ITarget_in,sz,spacing,
    ...
    :param model_name:
    :param use_map:
    :param compute_inverse_map:
    :param map_low_res_factor:
    :param compute_similarity_measure_at_low_res:
    :param spline_order:
    :param individual_parameters:
    ...
    # do imports here to avoid circular imports
    ...
    if use_map:
        ...
        id = identity_map_multiN(sz, spacing)
    ...
    if use_map:
        rec_IWarped = compute_warped_image_multiNC(ISource, rec_phiWarped, spacing, spline_order)
    ...
    if use_map:
        if compute_similarity_measure_at_low_res:
            I1Warped = compute_warped_image_multiNC(lowResISource, phi_or_warped_image, lowResSpacing, spline_order)
            ...
            I1Warped = compute_warped_image_multiNC(ISource, phi_or_warped_image, spacing, spline_order)
    ...
    if 'lam' in model_pars:
        m = compute_vector_momentum_from_scalar_momentum_multiNC(model_pars['lam'], lowResISource, lowResSize,lowResSpacing)
