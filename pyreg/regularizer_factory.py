...
from data_wrapper import AdaptVal,MyTensor
...
class Regularizer(object):
    ...
    def compute_regularizer_multiN(self, v):
        ...
        """
        szv = v.size()
        reg = AdaptVal(MyTensor(1).zero_(), requires_grad=False)
...
class HelmholtzRegularizer(Regularizer):
    ...
    def _compute_regularizer_1d(self, v, alpha, gamma):
        Lv = AdaptVal(Variable(MyTensor(v.size()).zero_(), requires_grad=False))
