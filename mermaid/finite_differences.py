...
class FD(with_metaclass(ABCMeta, object)):
    ...
    def dXb(self,I):
        """Compute backward difference in x direction.
    ...
    def ddXc(self,I):
        """Compute second deriative in x direction.
...
class FD_np(FD):
    """Definitions of the abstract methods for numpy.
    """
...
class FD_torch(FD):
    """Definitions of the abstract methods for torch.
    """
