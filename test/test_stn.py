...
class Test_stn_2d(unittest.TestCase):
    ...
    def test_identity(self):
        ...
        id = Variable( torch.from_numpy( utils.identity_map_multiN([1,1,50,50]) ) )
        I1_warped = self.stn(I0,id)
        npt.assert_almost_equal(I1.data.numpy(),I1_warped.data.numpy(),decimal=4)
    ...
    def test_shift(self):
        ...
        I1[0, 0, 5:9,5:9] = 1
        id = Variable(torch.from_numpy(utils.identity_map_multiN([1, 1, 10,10])))
    ...
    def test_expand(self):
        ...
        I1[0,0,8,2]=0.25
        I1[0,0,8,8]=0.25
        id = Variable(torch.from_numpy(utils.identity_map_multiN([1, 1, 11,11])))
        id_expand = Variable(torch.zeros([1, 2, 11,11]))
        id_expand[0, :, :,:] = 0.5*id[0, :, :,:]
        I1_warped = self.stn(I0, id_expand)
        npt.assert_almost_equal(I1.data.numpy(), I1_warped.data.numpy(), decimal=4)
...
class Test_stn_3d(unittest.TestCase):
    ...
    def test_identity(self):
        ...
        id = Variable( torch.from_numpy( utils.identity_map_multiN([1,1,50,50,50]) ) )
        I1_warped = self.stn(I0,id)
        npt.assert_almost_equal(I1.data.numpy(),I1_warped.data.numpy(),decimal=4)
    ...
    def test_shift(self):
        ...
        id = Variable(torch.from_numpy(utils.identity_map_multiN([1, 1, 100,100,100])))
    ...
    def test_expand(self):
        ...
        id = Variable(torch.from_numpy(utils.identity_map_multiN([1, 1, 11,11,11])))
